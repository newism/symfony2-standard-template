...
use Nsm\Bundle\GeneratorBundle\Generator\Generator;
...
abstract class GeneratorCommand extends ContainerAwareCommand
{
    ...
    protected function getSkeletonDirs(BundleInterface $bundle = null)
    {
        ...
        if (isset($bundle) && is_dir($dir = $bundle->getPath().'/Resources/NsmGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }

        if (is_dir($dir = $this->getContainer()->get('kernel')->getRootdir().'/Resources/NsmGeneratorBundle/skeleton')) {
            $skeletonDirs[] = $dir;
        }
