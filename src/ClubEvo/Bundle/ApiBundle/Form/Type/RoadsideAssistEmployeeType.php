...
/**
 * Roadside Assist Employee Form Type
 */
class RoadsideAssistEmployeeType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'ClubEvo\Bundle\ApiBundle\Entity\RoadsideAssistEmployee',
