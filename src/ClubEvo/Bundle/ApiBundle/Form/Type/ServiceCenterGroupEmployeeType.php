...
/**
 * Service Center Group Employee Form Type
 */
class ServiceCenterGroupEmployeeType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'ClubEvo\Bundle\ApiBundle\Entity\ServiceCenterGroupEmployee',
