...
use Nsm\Bundle\GeneratorBundle\Command\GenerateBundleCommand;
...
class GenerateBundleCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Command\GenerateBundleCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Generator\BundleGenerator')
