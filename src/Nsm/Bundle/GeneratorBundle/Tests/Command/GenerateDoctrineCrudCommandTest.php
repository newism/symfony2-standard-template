...
namespace Nsm\Bundle\GeneratorBundle\Tests\Command;

use Symfony\Component\Console\Tester\CommandTester;
use Nsm\Bundle\GeneratorBundle\Command\GenerateDoctrineCrudCommand;
...
class GenerateDoctrineCrudCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Command\GenerateDoctrineCrudCommand')
    ...
    protected function getGenerator()
    {
        ...
        return $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Generator\DoctrineCrudGenerator')
            ->disableOriginalConstructor()
    ...
    {
        return $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Generator\DoctrineFormGenerator')
            ->disableOriginalConstructor()
            ->setMethods(array('generate'))
            ->getMock()
        ;
