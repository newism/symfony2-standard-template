...
class AbstractController extends FOSRestController
{
    ...
    public function getEntityManager()
    {
        ...
        if (null === $this->entityManager) {
            ...
            $this->entityManager = $this->get(sprintf('club_evo_api.entity.%s_manager', $entityDiscriminator));
        }
    ...
    public function find($entityDisriminator, $id)
    {
        ...
        $entity = $em->getRepository('ClubEvoApiBundle:' . $entityDisriminator)->find($id);
    ...
    public function getTemplate($template)
    {
        ...
        $templatePath = sprintf("ClubEvoApiBundle:%s:%s.html.twig", $class, $template);
