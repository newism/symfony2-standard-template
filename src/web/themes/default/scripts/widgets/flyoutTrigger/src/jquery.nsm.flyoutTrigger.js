...
(function ($, window, document, undefined) {
    ...
    $.widget('nsm.flyoutTrigger', {
         ...
         * @private
         */
        _onFlyoutMouseOver: function(event) {
            this.show(event);
        },
        ...
        reposition: function () {
            ...
            var $window = $(window),
                ...
                flyoutTests = {
                    canFitTop: (flyoutHeight - flyoutTriggerHeight) < flyoutTriggerDistanceFromViewportBottom,
                    canFitBottom: (flyoutHeight - flyoutTriggerHeight) < flyoutTriggerDistanceFromViewportBottom,
                ...
                flyoutPositions = {
                    ...
                    bottomLeft: {
                        top: flyoutTriggerBottom - flyoutHeight,
                        left: flyoutTriggerLeft
                    },
                    bottomCenter: {
                        top: flyoutTriggerBottom - flyoutHeight,
