...
use Nsm\Bundle\GeneratorBundle\Command\GenerateControllerCommand;
...
class GenerateControllerCommandTest extends GenerateCommandTest
{
    ...
    {
        $command = $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Command\GenerateControllerCommand')
    ...
    protected function setGenerator()
    {
        ...
        $this->generator = $this
            ->getMockBuilder('Nsm\Bundle\GeneratorBundle\Generator\ControllerGenerator')
